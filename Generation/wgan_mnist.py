...
def train_step(state_g, state_d, noise, real):
    ...
    # discriminator parameter clip
    clip_params_d = jax.tree_map(lambda x: jnp.clip(x, -0.01, 0.01), state_d.params)
    state_d = state_d.replace(params=clip_params_d)
...
def main():
    ...
    save_dir = 'exp_results/MNIST/wgan_clip/'
